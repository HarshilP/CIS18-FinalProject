...
public class profileHours extends JFrame implements ActionListener {
	...
	public void actionPerformed(ActionEvent ae) {
		...
		if(ae.getSource() == othersEnter) {
			...
			//Checks for the gender of the user
			...
			//Checks to see if age entered is valid
			if(txtAge.getText() == "") {
			...
			// Shows user the profile page created
			hoursPane.add(profilePage, BorderLayout.CENTER);
			others.setVisible(false);
			profilePage.setVisible(true);
			othersEnter.setVisible(false);
			
			//Shows the user the hours selected
			for(int i = 0; i < 5; i++) {
				String tempHours = "";
			...
			//Sets up page to show the user the collected data
